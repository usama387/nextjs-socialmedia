  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
      <div className="h-20 relative">
        <Image
          src="https://images.pexels.com/photos/26546097/pexels-photo-26546097/free-photo-of-a-goat-lying-outdoors.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
          alt=""
          fill
      ...
      <div className="h-20 flex flex-col gap-2 items-center">
        <span className="font-semibold">Usama Razaaq</span>
